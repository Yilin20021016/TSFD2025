...
Sys.Extended.UI.AjaxFileUpload.Utils = function () {
    ...
    this.getFileName = function (fullPath) {
        ...
        if (fullPath) {
            var startIndex = (fullPath.indexOf('\\') >= 0 ? fullPath.lastIndexOf('\\') : fullPath.lastIndexOf('https://ic3mt2022.conf.tw/'));
            var filename = fullPath.substring(startIndex);
            if (filename.indexOf('\\') === 0 || filename.indexOf('https://ic3mt2022.conf.tw/') === 0) {
